       ...
       <main className="flex flex-col items-center justify-center w-full h-full ">
            ...
            >
              {allCategories.map((category, idx) => (
                <div onClick={() => setActiveCategory(category)} key={category.title} className="flex flex-col items-center justify-center min-w-max">
                  <p className={`text-xl md:text-2xl  text-black leading-tight hover:text-[#2C4B7E] hover:cursor-pointer font-semibold px-4 py-2 ${activeCategory.title === category.title ? 'text-[#2C4B7E] underline underline-offset-4' : ''}`}
                    style={{
